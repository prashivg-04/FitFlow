...
import { getJoinRequests, updateJoinRequestStatus, getMembers } from '../controllers/owner.controller.js';
...
router.get('/members', requireAuth, requireOwner, asyncHandler(getMembers));
