      ...
      <div className='max-w-7xl mx-auto space-y-6 sm:space-y-8'>
        ...
        <div className='flex flex-col sm:flex-row sm:items-center justify-between gap-4'>
          <div className='flex flex-col items-start'>
            ...
            <p className='text-[#61896f] text-base sm:text-lg mt-1'>Manage your account preferences, security settings, and personal profile.</p>
          </div>
        </div>
                  ...
                  <div className='col-span-1 sm:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4'>
                    <div>
                      ...
                      <div className='relative'>
                        <i className="fa-regular fa-envelope absolute left-2 top-1/2 -translate-y-1/2 text-lg"></i>
              ...
              <div className='mb-6 space-y-4'>
                ...
                <div>
                  ...
                  <div className='flex items-center gap-2 mt-1'>
                    <i className="fa-regular fa-credit-card text-gray-400 text-[18px]"></i>
