        ...
        <div className='max-w-300 mx-auto space-y-6 sm:space-y-8 pb-10'>
          ...
          <div className='flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4'>
            <div className='flex flex-col items-start justify-center gap-1 sm:gap-2'>
              <h1 className='text-3xl sm:text-4xl font-black tracking-tight'>Support Center</h1>
              <p className='text-[#61896f] text-sm sm:text-base'>Find answers quickly or get in touch with our team.</p>
            </div>
